...
export function KeyInsightsCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {INSIGHTS.map((insight) => (
        <Card key={insight.id} className="hover:border-primary/30 transition-all hover:shadow-sm">
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between">
              ...
              <div className="text-primary/50 flex-shrink-0">{insight.icon}</div>
            </div>
          </CardHeader>
          <CardContent>
